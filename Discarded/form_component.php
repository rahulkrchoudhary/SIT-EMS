                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                               ...
                               <label class="checkbox-inline">
                                  ...
                                  <label class="checkbox-inline">
                                    <input type="checkbox" name="department[]"  value="CS-IT"> CSIT
                                  </label>
                                  <label class="checkbox-inline">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <div class="radio">
                                          <label>
                                            <input type ="radio" name="group1" name =" Curricular Activity" checked onclick="hide_dropdown();" checked>
                                            CURRICULAR ACTIVITY
                                          </label>
                                        </div>
                                        <div class="radio">
                                        ...
                                        <div id="drop_down">
                                                  ...
                                                  <option value="" disabled selected>Choose your option</option>
                                                    ...
                                                    <option value="Industrial Institute Activity">Industrial Institute Activity</option>
